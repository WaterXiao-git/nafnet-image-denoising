...
if __name__ == "__main__":
    ...
    # 设置任务类型和输入图像路径
    task_type = "Image Denoising"  # 去噪任务
    image_path = "D:/match/图片去噪/datasets/val/00001.png"  # 替换为你的图像路径
    output_path = predictor.predict(task_type=task_type, image=Path(image_path), image_r=None)
